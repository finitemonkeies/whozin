              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-xl border border-white/5">
                    ...
                    >
                      <div
                        className={`absolute top-1 w-5 h-5 bg-white rounded-full shadow-md transition-all ${smsEnabled ? "right-1" : "left-1"}`}
                      />
                    </button>
                  </div>
                </div>
                ...
                <p className="text-xs text-center text-zinc-600">
                  We&apos;ll never text anyone without you tapping Send.
                </p>
              </div>
            )}
