  ...
  useEffect(() => {
    ...
    loadTimerRef.current = window.setTimeout(() => {
      if (justOnboarded) {
        ...
        setTickets(hasTickets ? EVENTS.slice(0, 1) : []);
      }
      setLoading(false);
          ...
          <>
            ...
            >
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold mb-2">New Ticket Detected!</h2>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center px-6">
          <div className="w-full max-w-md rounded-2xl border border-white/20 bg-zinc-950/90 p-8 shadow-2xl">
            <div className="text-center">
              ...
              <p className="mt-3 text-sm text-zinc-300">Ticket Wallet is launching soon.</p>
            </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-zinc-500 max-w-xs mb-8">
        When you buy a ticket, it'll show up here automatically.
      </p>
